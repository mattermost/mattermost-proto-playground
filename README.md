...
- `@mattermost/compass-ui` — published core from npm (`@alpha` / `0.1.0-alpha.4+`; tokens, primitives, web chrome). Import via **subpaths** (`@mattermost/compass-ui/components/button`), not the root barrel.
