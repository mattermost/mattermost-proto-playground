...
- Secondary text/borders/fills: `rgba(var(--center-channel-color-rgb), <alpha>)`. Text alpha ≥ **0.72** (placeholder text may use **0.64**; disabled controls may use **0.56** / lower); icon alpha ≥ **0.56**.
