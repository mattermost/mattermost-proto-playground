...
/**
 * Catalog toolbar — resource scope in a dropdown (not pills), plus eligibility
 * filter, list/audit toggle, and search.
 */
      ...
      <div className={styles['bar__right']}>
        ...
        >
          <button
            ...
            className={`${styles['bar__toggle-btn']} ${viewMode === 'list' ? styles['bar__toggle-btn--active'] : ''}`}
          ...
          <button
            ...
            className={`${styles['bar__toggle-btn']} ${viewMode === 'audit' ? styles['bar__toggle-btn--active'] : ''}`}
