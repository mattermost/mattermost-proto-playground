...
import styles from './AttributeManagementVariationF.module.scss';

/**
 * Attribute Management — Variation F (System Console · value counts)
 *
 * Same as Variation E, but the catalog table shows value counts only (e.g.
 * "4 values"). Full value lists appear on the attribute detail page.
 * Externally synced attributes still show Managed by UAS/LDAP indicators.
 */
export default function AttributeManagementVariationF() {
  const initialParams =
            ...
            {selected ? (
              ...
              <>
                <p className={styles['console__description']}>
                  Define an attribute once, then customize which catalog values
                  are allowed per resource. Open an attribute to view and edit
                  its values.
                </p>
