...
} from './gmpSimplifiedWalkthroughSteps';

import styles from './GlobalMembershipPolicySimplifiedWalkthrough.module.scss';
...
export default function GlobalMembershipPolicySimplifiedWalkthrough() {
    ...
    <div className={styles['gmp-tour']}>
      <header className={styles['gmp-tour__header']}>
        <div>
          ...
          <h1 className={styles['gmp-tour__title']}>
            Global Membership Policies — Simplified
          </h1>
          <p className={styles['gmp-tour__subtitle']}>
            One paired channel attribute per requirement, two scope choices, and a
            fail-secure save guardrail — step by step.
          </p>
        </div>
