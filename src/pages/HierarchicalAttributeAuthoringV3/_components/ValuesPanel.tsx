    ...
    <div className={styles['values']}>
      ...
      {editing && editingValue && (
        <ValueEditorPopover
          ...
          onShowUnder={(parentId) => {
            setValues((prev) =>
              withShownUnder(prev, editing.valueId, parentId),
            );
            setAnnounce(
              `“${labelOf(values, editing.valueId)}” is now listed under “${labelOf(values, parentId)}”. Access did not change — all parents grant equally — and its position under each parent is untouched.`,
            );
            setEditing(null);
          }}
          onRequestDelete={() => {
