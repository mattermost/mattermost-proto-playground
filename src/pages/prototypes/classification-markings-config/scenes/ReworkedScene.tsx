...
import ClearanceRankMap from '../components/ClearanceRankMap';
...
export default function ReworkedScene() {
  ...
  return (
    <div className={styles['markings-config__body']}>
      ...
      <AdminPanel
        ...
        subtitle="Compare a ranked user attribute to resource classification, and choose which resources to enforce."
      >
          ...
          <div className={styles['markings-config__settings']}>
            <div className={styles['markings-config__setting']}>
              ...
              <div className={styles['markings-config__setting-fields']}>
                ...
                <p className={styles['markings-config__help']}>
                  When enabled, a membership policy compares each user&apos;s
                  ranked clearance attribute against a resource&apos;s
          ...
          {enforce ? (
            <>
              <div className={styles['markings-config__settings']}>
                <div className={styles['markings-config__setting']}>
                  <div
                    className={styles['markings-config__setting-label']}
                    aria-hidden="true"
                  />
                  <div className={styles['markings-config__setting-fields']}>
                    <SectionNotice
                      type="Info"
                      title="Enforcement uses a ranked user attribute"
                      description="Select a ranked user attribute such as Clearance. A membership policy compares that attribute to each resource’s classification using the rank mapping below."
                    />
                  </div>
                </div>
                ...
                <div className={styles['markings-config__setting']}>
                  ...
                  <div className={styles['markings-config__setting-fields']}>
                    ...
                    <p className={styles['markings-config__help']}>
                      Must be a ranked type applied to users.
                    </p>
                  </div>
                </div>
              </div>
              ...
              {selectedAttribute ? (
                <ClearanceRankMap
                  levels={levels}
                  clearanceValues={selectedAttribute.values}
                  mapping={rankMap}
      ...
      >
        <ResourceSpecificSettings
          ...
          lockedResources={enforceResources}
