...
import { OPTION3_PANEL_OPTIONS } from '@/pages/prototypes/channel-automations/panelOptions';
  ...
  useEffect(() => {
    setCenterSlot(
      <SceneSwitcher
        ...
        ariaLabel="Automation agents scene"
      />,
    );
    ...
    <div className={frameStyles['prototype-app-frame']}>
      {scene === 'discover' && (
        <DiscoverScene
          ...
          panelOptions={OPTION3_PANEL_OPTIONS}
