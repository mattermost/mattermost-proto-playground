...
import styles from './HierarchicalAttributeAuthoringV3EqualParents.module.scss';
...
/**
 * Hierarchical attribute authoring — V3 equal-parents variant. [AI DRAFT]
 *
 * Identical to the corrected V3 authoring surface except the home/editing
 * occurrence is retired: every parent edge renders a full row with the same edit
 * controls, children, and per-parent reordering. Multi-parent values carry a
 * link-icon "N parents" tag on every occurrence.
 */
export default function HierarchicalAttributeAuthoringV3EqualParents() {
