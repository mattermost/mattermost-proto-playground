...
/**
 * Scrollbars — wraps content in a SimpleBar overlay scroller.
 *
 ...
 */
const Scrollbars = forwardRef<HTMLDivElement, ScrollbarsProps>(function Scrollbars(
  ...
  const rootClass = [styles.scrollbars, className].filter(Boolean).join(' ');
