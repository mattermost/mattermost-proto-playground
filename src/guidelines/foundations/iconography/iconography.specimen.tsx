...
export default function IconographyLibrary() {
  return (
    <>
      <p>
        Below are all the icons in the Compass Icons package.
      </p>

      {SORTED_GLYPHS.length === 0 ? (
        <p>No icons could be loaded from the Compass Icons package.</p>
      ) : (
            ...
            <div className={styles['foundations__icon-grid']}>
              {SORTED_GLYPHS.map((glyph) => {
                ...
                return (
                  <div
                    key={glyph}
                    className={styles['foundations__icon-cell']}
                  >
                    <span
