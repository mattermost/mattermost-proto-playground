...
/**
 * Section groupings for the unified Topic sidebar, keyed by category.
 * Categories without an entry render as a flat list in manifest order.
 *
 * Foundations folds the former overview entries into a leading "Overview"
 * section. Components mirrors the per-category groupings used in the
 * library/guideline sidebars before the merge.
 */
